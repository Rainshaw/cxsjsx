...
void longSeeSoliderUseArrow(int mytime){
    for(int i=1;i<=N;i++){
        ...
        if(solider1&&solider1->haveArrow()&&city[i+1].citybluesolider){
            ...
            if(!solider2->isalive()) {
                printf("000:35 red dragon 1 shot and killed red lion 4");
            }
        ...
        if(solider1&&solider1->haveArrow()&&city[i-1].cityredsolider){
